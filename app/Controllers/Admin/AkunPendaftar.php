...
class AkunPendaftar extends BaseController
{
    ...
    public function index()
    {
        ...
        $data = [
            'title' => 'ADMIN | AKUN PENDAFTAR',
        ];
        // $users = new \Myth\Auth\Models\UserModel();
        // $data['users'] = $users->findAll();


        $this->builder->select('users.id as userid, username,noakun,email,name,fullname');
        ...
        return view('admin/akunpendaftar', $data);
    }
