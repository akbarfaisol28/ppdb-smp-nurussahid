            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form action="/user/formulirpendaftaranUser/save" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <?= csrf_field(); ?>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="nisn" name="nisn" placeholder="Masukkan NISN" class="form-control" value="<?= old('nisn'); ?>"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="nama" class=" form-control-label">Nama</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="nama" name="nama" placeholder="Masukkan Nama Lengkap" class="form-control" value="<?= old('nama'); ?>"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="alamat" class=" form-control-label">Alamat</label></div>
                                <div class="col-12 col-md-9"><textarea name="alamat" id="alamat" rows="5" placeholder="Masukkan Alamat" class="form-control" value="<?= old('alamat'); ?>"></textarea></div>
                            </div>
                            <div class="row form-group">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="jns_klmn" id="jns_klmn" class="form-control" value="<?= old('jns_klmn'); ?>">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="telepon" name="telepon" placeholder="Masukkan Nomor Telepon" class="form-control" value="<?= old('telepon'); ?>"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="asal_sklh" class=" form-control-label">Asal Sekolah</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="asal_sklh" name="asal_sklh" placeholder="Masukkan Asal Sekolah" class="form-control" value="<?= old('asal_sklh'); ?>"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="alamat_sklh" class=" form-control-label">Alamat Sekolah</label></div>
                                <div class="col-12 col-md-9"><textarea name="alamat_sklh" id="alamat_sklh" rows="5" placeholder="Masukkan Alamat Sekolah" class="form-control" value="<?= old('alamat_sklh'); ?>"></textarea></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="thn_lulus" class=" form-control-label">Tahun Lulus</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="thn_lulus" name="thn_lulus" placeholder="Masukkan Tahun Lulus" class="form-control" value="<?= old('thn_lulus'); ?>"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="nama_ayah" class=" form-control-label">Nama Ayah</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="nama_ayah" name="nama_ayah" placeholder="Masukkan Nama Ayah" class="form-control" value="<?= old('nama_ayah'); ?>"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="pkrjn_ayah" class=" form-control-label">Pekerjaan Ayah</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="pkrjn_ayah" name="pkrjn_ayah" placeholder="Masukkan Pekerjaan Ayah" class="form-control" value="<?= old('pkrjn_ayah'); ?>"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="gaji_ayah" class=" form-control-label">Gaji Ayah</label></div>
                                <div class="col-12 col-md-9">
                                    <select name="gaji_ayah" id="gaji_ayah" class="form-control" value="<?= old('gaji_ayah'); ?>">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="nama_ibu" name="nama_ibu" placeholder="Masukkan Nama Ibu" class="form-control" value="<?= old('nama_ibu'); ?>"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="pkrjn_ibu" class=" form-control-label">Pekerjaan Ibu</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="pkrjn_ibu" name="pkrjn_ibu" placeholder="Masukkan Pekerjaan Ibu" class="form-control" value="<?= old('pkrjn_ibu'); ?>"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="gaji_ibu" class=" form-control-label">Gaji Ibu</label></div>
                                <div class="col-12 col-md-9">
                                    <select name="gaji_ibu" id="gaji_ibu" class="form-control" value="<?= old('gaji_ibu'); ?>">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="file" id="kk" name="kk" multiple="" class="form-control-file" value="<?= old('kk'); ?>"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="foto" class=" form-control-label">Foto Pribadi</label></div>
                                <div class="col-12 col-md-9"><input type="file" id="foto" name="foto" multiple="" class="form-control-file" value="<?= old('foto'); ?>"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="ijazah" class=" form-control-label">Foto Ijazah</label></div>
                                <div class="col-12 col-md-9"><input type="file" id="ijazah" name="ijazah" multiple="" class="form-control-file" value="<?= old('ijazah'); ?>"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="akte" class=" form-control-label">Foto Akta Kelahiran</label></div>
                                <div class="col-12 col-md-9"><input type="file" id="akte" name="akte" multiple="" class="form-control-file" value="<?= old('akte'); ?>"></div>
                            </div>
