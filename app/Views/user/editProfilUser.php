            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form action="/user/profilUser/update/<?= $users['id']; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <?= csrf_field(); ?>
                            ...
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="fullname" class=" form-control-label">Nama</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="fullname" name="fullname" placeholder="Masukkan fullname" class="form-control" value="<?= (old('fullname')) ? old('fullname') : $users['fullname']; ?>"></div>
                            </div>
                            <div class="row form-group">
